...
# Function to generate a review using T5 with random selection of questions
def generate_t5_review(row):
    ...
    # Combine the selected templates into a full review
    review_template = " ".join(random.choice(questions_templates[q]) for q in selected_questions)

    return review_template

# Generate Google reviews and add to a new column
